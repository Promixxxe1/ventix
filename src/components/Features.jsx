...
const features = [
  {
    ...
    codeSnippets: `function handleSubmit(){
...
const Features = () => {
  return (
    <section
      id="features"
      className="py-16 sm:py-20 px-10 sm:px-6 lg:px-8 relative animate-in slide-in-from-bottom duration-1000 delay-700"
    >
